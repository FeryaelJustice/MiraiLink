...
class SwipeRepositoryImpl(
    ...
    override suspend fun likeUser(toUserId: String): MiraiLinkResult<Boolean> = remote.likeUser(toUserId)

    override suspend fun dislikeUser(toUserId: String): MiraiLinkResult<Unit> = remote.dislikeUser(toUserId)
}
