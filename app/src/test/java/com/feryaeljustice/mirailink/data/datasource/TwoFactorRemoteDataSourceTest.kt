...
class TwoFactorRemoteDataSourceTest : UnitTest() {
    ...
    @Test
    fun `get2FAStatus should return status on success`() =
        runTest {
            // Given
            val userId = "user123"
    ...
    @Test
    fun `setup2FA should return setup details on success`() =
        runTest {
            // Given
            val response =
    ...
    @Test
    fun `verify2FA should return success`() =
        runTest {
            // Given
            val code = "123456"
    ...
    @Test
    fun `disable2FA should return success`() =
        runTest {
            // Given
            val code = "123456"
