...
class MatchRepositoryImplTest {
    ...
    @Test
    fun `getMatches returns success when remote data source is successful`() = runTest {
        // Given
    ...
    @Test
    fun `getMatches returns error when remote data source fails`() = runTest {
        // Given
    ...
    @Test
    fun `getUnseenMatches returns success when remote data source is successful`() = runTest {
        // Given
        val userDtoList = listOf(userDto)
        val successResult = MiraiLinkResult.Success(userDtoList)
    ...
    @Test
    fun `getUnseenMatches returns error when remote data source fails`() = runTest {
        // Given
        val errorResult = MiraiLinkResult.Error("An error occurred")
    ...
    @Test
    fun `markMatchAsSeen returns success when remote data source is successful`() = runTest {
        // Given
    ...
    @Test
    fun `markMatchAsSeen returns error when remote data source fails`() = runTest {
        // Given
        val matchIds = listOf("1", "2")
        val errorResult = MiraiLinkResult.Error("An error occurred")
