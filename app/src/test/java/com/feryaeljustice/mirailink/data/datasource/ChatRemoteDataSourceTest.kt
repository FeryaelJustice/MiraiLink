...
class ChatRemoteDataSourceTest : UnitTest() {
    ...
    @Test
    fun `getChatsFromUser should return list of chat summaries`() =
        runTest {
            // Given
            val chatSummaries =
                listOf(
    ...
    @Test
    fun `markChatAsRead should return success`() =
        runTest {
            // Given
            val chatId = "1"
    ...
    @Test
    fun `createPrivateChat should return chat ID on success`() =
        runTest {
            // Given
    ...
    @Test
    fun `createPrivateChat should return existing chat ID on 409 conflict`() =
        runTest {
            // Given
            val otherUserId = "user2"
    ...
    @Test
    fun `createGroupChat should return chat ID on success`() =
        runTest {
            // Given
    ...
    @Test
    fun `sendMessage should return success`() =
        runTest {
            // Given
    ...
    @Test
    fun `getChatHistory should return list of messages`() =
        runTest {
            // Given
